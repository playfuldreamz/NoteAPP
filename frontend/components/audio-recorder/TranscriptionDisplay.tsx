      ...
      <div>
        ...
        <div className={`transition-all duration-300 ease-in-out ${isOriginalCollapsed ? 'max-h-0 opacity-0 overflow-hidden' : 'opacity-100'}`}>
          <div
            ...
            className={`p-4 bg-gray-100 dark:bg-gray-700 rounded-lg min-h-[2.5rem] max-h-[7.5rem] overflow-y-auto custom-scrollbar transition-all duration-300`}
            aria-live="polite"
          >
            ...
            {isEnhancing && (
             ...
             <div className={`transition-all duration-300 ease-in-out ${isEnhancedCollapsed ? 'max-h-0 opacity-0 overflow-hidden' : 'opacity-100'}`}>
                <div
                    ...
                    className={`p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg min-h-[2.5rem] max-h-[7.5rem] overflow-y-auto custom-scrollbar transition-all duration-300`}
                >
